...
from src.constants import device, gptneox_tokenizer as tokenizer
...
#%%
for (model_name, model), dirs_dict in zip(models.items(), load_dirs("n1-dgender", "she-he")):
    plot_tests(hard_gender_tests, dirs_dict, model, model_name)
...
#%%
for (model_name, model), dirs_dict in zip(models.items(), load_dirs("n1-dgender")):
    plot_tests(french_gender_tests, dirs_dict, model, model_name)
